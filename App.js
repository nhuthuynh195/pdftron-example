...
export default class App extends Component<Props> {
  ...
  render() {
    ...
    const myToolbar = [
      {
        [Config.CustomToolbarKey.Id]: 'PDFTron_View',
        [Config.CustomToolbarKey.Icon]: Config.ToolbarIcons.View,
        [Config.CustomToolbarKey.Name]: 'View',
        [Config.CustomToolbarKey.Items]: [Config.Buttons.viewControlsButton],
      },
      {
        [Config.CustomToolbarKey.Id]: 'PDFTron_Annotate',
